    ...
    <FixedLayout>
      ...
      <Container paddingTop={'0 !important'}>
        <BlockItem
          ...
          list={[
            'Complete migration from Material-UI v4 to Material-UI v5',
            'Update versions of npm dependencies including react, next.js, gatsby.js and related libraries',
            'Code architectural changes - removing atomic components and compositions and using pure Material-UI components',
            ...
            'Remove the Font Awesome library and its dependencies (using only Material-UI icons and Hero Icons - https://heroicons.com/)',
